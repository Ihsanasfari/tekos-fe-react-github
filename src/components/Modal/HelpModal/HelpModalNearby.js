...
function HelpModalNearby(props) {
        ...
        <div className="flex flex-col gap-8  font-poppins w-64 sm:w-[400px] lg:w-fit">
          ...
          <div className="flex flex-col gap-2">
            <h4 className="text-slate-800 text-2xl font-semibold">
              Kategori Telyu Nearby
            </h4>

            <div className="flex flex-col gap-2 divide-y-2 divide-dotted text-base font-normal lg:w-[800px]">
              <Link onClick={onClose} to="/helpFindNearby" className="">
                Bagaimana cara mencari informasi makanan, minuman, dan jasa di
                TEKOS?
              </Link>
              <Link onClick={onClose} to="/helpContactNearby" className="pt-2">
                Bagaimana cara mendapatkan kontak pemilik makanan, minuman, dan
                jasa di TEKOS?
              </Link>
            </div>
          </div>
...
export default HelpModalNearby;
